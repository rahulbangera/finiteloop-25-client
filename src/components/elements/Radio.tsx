...
const Radio: React.FC<RadioProps> = ({ plans, selected, setSelected }) => {
	...
	return (
		<div className="relative grid grid-cols-3 grid-rows-2 md:grid-rows-1 md:grid-cols-6 bg-white/35 dark:bg-white/10 rounded-xl backdrop-blur-md shadow-[inset_1px_1px_4px_rgba(255,255,255,0.2),inset_-1px_-1px_6px_rgba(0,0,0,0.3),0_4px_12px_rgba(0,0,0,0.15)] overflow-hidden w-full sm:w-fit">
			{/* Mobile Glider */}
			<div
