			...
			<div className=" mt-20 m-15 flex flex-col">
				...
				<div className="flex flex-col gap-5 text-xl text-center dark:text-white/80 text-black/80 font-bold">
					...
					<p>
						...
						privacy policy govern FINITE LOOP CLUB's relationship with you in
						relation to this website.
					</p>
					<span>
						<p>
							The term 'FINITE LOOP CLUB' or 'us' or 'we' refers to the owner of
							the website whose registered/operational office is:
						</p>
					...
					<div className="text-left">
						...
						<ul className="list-disc list-inside pl-5">
							...
							<li>
								...
								or document without FINITE LOOP CLUB’s prior written consent.
							</li>
							<li>
