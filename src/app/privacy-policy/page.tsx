		...
		<main>
			<div className=" mt-20 m-15 flex flex-col">
				...
				<div className="flex flex-col gap-5 text-xl text-center dark:text-white/80 text-black/80 font-bold">
					<p>
						This privacy policy sets out how FINITE LOOP CLUB uses and protects
						any information that you give FINITE LOOP CLUB when you use this
						website.
					</p>
					<p>
						FINITE LOOP CLUB is committed to ensuring that your privacy is
					...
					<p>
						FINITE LOOP CLUB may change this policy from time to time by
					...
					<p className="text-2xl text-black/90 dark:text-white/90">
